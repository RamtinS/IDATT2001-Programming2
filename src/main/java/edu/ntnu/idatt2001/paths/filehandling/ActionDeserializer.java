...
public class ActionDeserializer implements JsonDeserializer<Action> {
   ...
   * The method only supports Action objects determined by the ActionType enum.
   *
   ...
   * @throws JsonParseException if JsonElement cannot be deserialized because of unknown action type.
   */
  @Override
